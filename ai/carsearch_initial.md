...
- `kenteken.csv` wordt in de browser ingelezen als kentekenhistorie. Eerder geziene kentekens tonen bij één unieke datum die datum, of anders het aantal unieke datums met de eerste en recentste datum. Ze krijgen 200 bonuspunten wanneer een bijzonderheidsscore beschikbaar is.
